...
int HoraTotal = 0;                //en esta variable se guradara el tiempo que se envia desde la app y es el que debera de durar el mezclado
int TiempoHor = 0;
int TiempoMin = 0;
long TiempoHorUso = 0;
...
void setup() {
  ...
  Timer5.initialize(250000);        //configuramos el timer para que cada 250 ms lea los datos que vienen del arduino mediante la funcion lectura,
